...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [129 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 12213344; uint32_t buffer_offset
	}, ; 126: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 21536, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12384352; uint32_t buffer_offset
	}, ; 127: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2021888, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12405888; uint32_t buffer_offset
	} ; 128: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 14427776, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [14427776 x i8] zeroinitializer, align 1
